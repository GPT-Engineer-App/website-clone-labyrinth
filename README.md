...
**Project**: website-clone-labyrinth 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: build an exact replica of this website 
...
```sh
git clone https://github.com/GPT-Engineer-App/website-clone-labyrinth.git
cd website-clone-labyrinth
npm i
